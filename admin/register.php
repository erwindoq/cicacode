...
$nama=$username=$email=$password=$nama1=$nama2=$nama3=$username1=$username2=$username3=$username4=$email1=$email2=$email3=$password1=$password2="";
 ...
 */
$cekusername        = "SELECT username FROM admin WHERE username='$username'";
 ...
 * cek validasi email
 */
$cekemail       = "SELECT email FROM admin WHERE email='$email'";
 ...
 */
if(!$error) {
mysql_query("INSERT INTO admin(adminid, email, password, username, name, avatar, cover, regdate, lastlog, verified, active, banned) VALUES('','$email','$hash','$username','$namafix','0','0','$timeuser','$timeuser','0','0','0')");
